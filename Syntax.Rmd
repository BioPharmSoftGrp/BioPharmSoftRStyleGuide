...
ease. Put space around arithematic and logical operators, and after
",". Whether space should be inserted immediately after "("/"[" and
before ")"/"]" is a matter of personal choice, but whatever style you
...
Code should be organized so that there is less repetition and more abstraction.
    ...
    # Better Example
      f <- function(x, y) sin(x) + exp(b)
      a <- f(2.4, -2)
      b <- f(1.2, 5.7)
      c <- a + b

One liner function definitions are reasonable if the line is short, however for readability
...
There are three ways to assign a variable values in R.
...
Even though "=" and "<-" are interchangeble, typical R style guides
